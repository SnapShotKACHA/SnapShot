...
class UnsealedState<R>: State<R> {
    fileprivate let barrier = DispatchQueue(label: "org.promisekit.barrier", attributes: DispatchQueue.Attributes.concurrent)
    fileprivate var seal: Seal<R>
