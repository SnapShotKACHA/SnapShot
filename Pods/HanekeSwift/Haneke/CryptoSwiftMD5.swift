...
class HashBase {
    ...
    func prepare(_ len: Int = 64) -> NSMutableData {
        let tmpMessage: NSMutableData = NSData(data: self.message) as Data
...
class MD5 : HashBase {
    ...
    func calculate() -> Data {
        ...
        tmpMessage.appendBytes(lengthBytes.reversed())
        ...
        for (var i = 0; i < tmpMessage.length; i = i + chunkSizeBytes, leftMessageBytes -= chunkSizeBytes) {
            ...
            (chunk as NSData).getBytes(UnsafeMutableRawPointer(M), range: range)
