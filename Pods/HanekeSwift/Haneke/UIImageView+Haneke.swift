...
public extension UIImageView {
    ...
    public func hnk_setImage(@autoclosure(escaping) _ image: () -> UIImage, key: String, placeholder : UIImage? = nil, format : Format<UIImage>? = nil, success succeed : ((UIImage) -> ())? = nil) {
